...
import { registerUser } from "../../../server/services/auth/authActions";
import { RegisterFormValues } from "../../../server/models/authFormTypes";
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          className={`p-3 border rounded-lg outline-none focus:ring-2 ${
            ...
            LIGHT_MODE_COLORS.TEXT_PRIMARY
          } ${DARK_MODE_COLORS.TEXT_PRIMARY} focus:ring-indigo-400 dark:focus:ring-indigo-500 transition-all ${ANIMATION_TIMINGS.TRANSITION_DURATION}`}
        />
        {errors.username && (
